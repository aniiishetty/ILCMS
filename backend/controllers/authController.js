    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, models_1.Admin.create({ Username: username, password: hashedPassword })];
            case 2:
                admin = _a.sent();
...
var login = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models_1.Admin.findOne({ where: { Username: username } })];
            case 1:
                admin = _a.sent();
                if (!admin)
...
var registerAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, admin, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, register(username, password)];
            case 2:
                admin = _b.sent();
...
var loginAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, admin, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, password = _a.password;
